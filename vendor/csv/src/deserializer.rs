...
impl<'r> DeRecord<'r> for DeStringRecord<'r> {
    ...
    fn infer_deserialize<'de, V: Visitor<'de>>(
        ...
        let x = self.next_field().expect("EYOOO infer des");
        if x == "true" {
...
impl<'r> DeRecord<'r> for DeByteRecord<'r> {
    ...
    fn infer_deserialize<'de, V: Visitor<'de>>(
        ...
        let x = self.next_field_bytes().expect("El infer?");
        if x == b"true" {
            return visitor.visit_bool(true);
        } else if x == b"false" {
            return visitor.visit_bool(false);
...
macro_rules! deserialize_int {
    ($method:ident, $visit:ident, $inttype:ty) => {
        fn $method<V: Visitor<'de>>(
            ...
            let field = self.next_field().expect("Troublesome int");
    ...
    for &'a mut DeRecordWrap<T>
{
    ...
    fn deserialize_char<V: Visitor<'de>>(
        ...
        let field = self.next_field().expect("Troublesome char");
    ...
    fn deserialize_str<V: Visitor<'de>>(
        ...
        self.next_field()
            ...
            .inspect_err(|_| println!("you silly str goose"))
    }
    ...
    fn deserialize_string<V: Visitor<'de>>(
        ...
        self.next_field()
            .and_then(|f| visitor.visit_str(f.into()))
            .inspect_err(|_| println!("you silly string goose"))
    }
    ...
    fn deserialize_bytes<V: Visitor<'de>>(
        ...
        self.next_field_bytes()
            ...
            .inspect_err(|_| println!("you silly byte goose"))
    }
    ...
    fn deserialize_byte_buf<V: Visitor<'de>>(
        ...
        self.next_field_bytes()
            ...
            .inspect_err(|_| println!("you silly byte buf goose"))
    }
    ...
    fn deserialize_ignored_any<V: Visitor<'de>>(
        ...
        let _ = self.next_field_bytes().map_err(|err| {
            println!("HOLA");
            std::io::Error::new(std::io::ErrorKind::Other, "Chupamela")
        });
        visitor.visit_unit()
    }
}
    ...
    for &'a mut DeRecordWrap<T>
{
    ...
    fn variant_seed<V: DeserializeSeed<'de>>(
        ...
        let variant_name =
            self.next_field().expect("NO SE NI QUE VERGA ES ESTO");
